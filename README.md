...
## Features
* Create lists whose items can be checked/un-checked for tracking purposes (preserved across sessions).
* Customize whether checked items remain in the same position in the list or automatically go to the bottom
...
NOTE: The script will also install the necessary Hearth framework, but if you point it to a directory where it already exists then it will give you the option to just install/update xlist.
...
## App Pics
[![View App Pics](https://img.shields.io/badge/App-Pics-blue)](https://karmahelen.github.io/xlist/AppPics.html)
...
xlist.primary904@passinbox.com
